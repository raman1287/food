	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         ...
                         <input type="number" class="form-control" pattern="" value="<?php if(isset($mob)) { echo $mob;}?>"id="mob" placeholder="" name="mob" required/>
                     </div>
	                 <div class="form-group">
                          <label for="phone">Phone:</label>
                          <input type="number" class="form-control" pattern="" id="phone" value="<?php if(isset($phone)) { echo $phone;}?>" placeholder="" name="phone" required>
                     </div>
	                 <div class="form-group">
